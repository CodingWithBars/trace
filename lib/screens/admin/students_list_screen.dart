  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new_rounded, color: TraceColors.white),
          onPressed: () => context.pop(),
        ),
        title: Text('List of Students', style: GoogleFonts.inter(fontWeight: FontWeight.w700, color: TraceColors.white)),
      ),
      body: SafeArea(
        child: Column(
                ...
                children: _programs.asMap().entries.map((entry) {
                  ...
                  return Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        margin: EdgeInsets.only(right: i == _programs.length - 1 ? 0 : 8),
                        padding: const EdgeInsets.symmetric(vertical: 8),
                        alignment: Alignment.center,
                        decoration: BoxDecoration(
                          color: _selectedProgram == program ? TraceColors.gold : Colors.white.withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(20),
                          border: _selectedProgram == program ? null : Border.all(color: Colors.white24),
                        ),
                        child: Text(program, style: GoogleFonts.inter(
                          color: _selectedProgram == program ? TraceColors.navyBlue : TraceColors.white,
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (ctx, snap) {
                  ...
                  final filteredDocs = _selectedProgram == 'All' 
                    ? allDocs 
                    : allDocs.where((doc) {
                        final course = (doc.data() as Map<String, dynamic>)['course']?.toString().toUpperCase() ?? '';
                  ...
                  return Column(
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Total Student: ${filteredDocs.length}', style: GoogleFonts.inter(
                            ...
                            DropdownButtonHideUnderline(
                              child: DropdownButton<bool>(
                                ...
                                icon: const Icon(Icons.sort_by_alpha, size: 20, color: TraceColors.navyBlue),
                                isDense: true,
                      ...
                      Expanded(
                        child: filteredDocs.isEmpty
                            ? Center(child: Text('No students found for this program.', style: GoogleFonts.inter(color: TraceColors.medGrey)))
                            : ListView.builder(
                                ...
                                itemBuilder: (ctx, i) {
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(color: TraceColors.navyBlue.withValues(alpha: 0.05), blurRadius: 10, offset: const Offset(0, 4)),
                                      ],
                                    ),
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(name, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: TraceColors.navyBlue)),
                                              const SizedBox(height: 4),
                                              Text('$course $year | $studentId', style: GoogleFonts.inter(fontSize: 13, color: TraceColors.medGrey)),
                                            ],
                                          ),
                                        ),
                                      ],
