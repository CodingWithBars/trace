...
class WebStudentSummaryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WebStudentSummaryScreen> createState() => _WebStudentSummaryScreenState();
}

class _WebStudentSummaryScreenState extends ConsumerState<WebStudentSummaryScreen> {
  Student? _student;
